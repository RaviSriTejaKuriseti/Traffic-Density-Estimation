...
for i in range(0,len(vec1)):
	D.append((utilitypercent(vec1[i])-99)*100)
...
plt.ylabel("(Utility-99)*100")  # add Y-axis label
...
#D=[99.58388579609476, 99.84645889440884, 99.91431434006017, 99.91298787157632, 99.92610279451384, 99.92800540439362]
