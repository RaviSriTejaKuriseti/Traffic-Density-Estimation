...
for i in range(0,len(vec1)):
	C.append((utilitypercent(vec1[i])-99.999)*100000)
...
plt.xlabel("(utility percentage-99.999)*100000")  # add X-axis label
plt.ylabel("Runtime in seconds")  # add Y-axis label
plt.title("Plot of utility vs runtime")  # add title
plt.show()

#C=[99.83029820688216, 99.93738209317371, 99.96505524156873, 99.9645142755412, 99.9698628703527, 99.97063880149426]
