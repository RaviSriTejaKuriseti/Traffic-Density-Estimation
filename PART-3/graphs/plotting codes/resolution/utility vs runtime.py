...
for i in range(0,len(vec1)):
	C.append((utilitypercent(vec1[i])-99)*100)
...
plt.xlabel("(utility percentage-99)*100")  # add X-axis label
plt.ylabel("Runtime in seconds")  # add Y-axis label
plt.title("Plot of utility vs runtime")  # add title
plt.show()

#C=[99.58388579609476, 99.84645889440884, 99.91431434006017, 99.91298787157632, 99.92610279451384, 99.92800540439362]
